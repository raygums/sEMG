...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen">
      {/* Sidebar */}
      <aside
        className="w-64 flex flex-col fixed top-0 left-0 bottom-0 z-30"
        style={{
      ...
      >
        ...
        <div className="p-5" style={{ borderBottom: '1px solid var(--border-default)' }}>
          <Link href="/" className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-sm font-bold" style={{ color: 'var(--text-primary)' }}>EMG Guide</h1>
        ...
        <div className="p-3" style={{ borderTop: '1px solid var(--border-default)' }}>
          <form action={logoutAction}>
            <button type="submit" className="btn btn-ghost w-full text-sm justify-start">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
